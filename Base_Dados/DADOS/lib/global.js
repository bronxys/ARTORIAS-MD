...
exports.shazamResult = (data) => {
  return `┌─⊷ *SHAZAM* 🎙️
▢  *𝚃𝚒́𝚝𝚞𝚕𝚘:*  ${data.resultado[0].title}
▢  *𝙳𝚞𝚛𝚊𝚌̧𝚊̃𝚘:*  ${data.resultado[0].timestamp} | ${data.resultado[0].seconds}𝚜
▢ *𝚅𝚒𝚜𝚞𝚊𝚕𝚒𝚣𝚊𝚌̧𝚘̃𝚎𝚜*  ${data.resultado[0].views}
————•
▢  *𝙻𝚒𝚗𝚔:* ${data.resultado[0].url}
└────────────────┈ ⳹`
}
...
exports.deezerMusic = (theMusicD, tempo, prefix) => {
return `
╭━━━━━ •𝐃𝐄𝐄𝐙𝐄𝐑_• ━━━━━╮

 ━ 「𝙸𝚗𝚏𝚘𝚛𝚖𝚊𝚌̧𝚘̃𝚎𝚜 𝚍𝚊 𝚖𝚞́𝚜𝚒𝚌𝚊_」
┃⫸ *𝚃𝚒́𝚝𝚚𝚕𝚘:* ${theMusicD.title}
┃⫸ *𝙻𝚒𝚗𝚔 - 𝙼𝚞́𝚜𝚒𝚌𝚊:* ${theMusicD.link}
┃⫸ *𝙳𝚞𝚛𝚊𝚌̧𝚊̃𝚘:* ${theMusicD.duration}s
╰════ ◍
┃⫸ *𝙰𝚛𝚝𝚒𝚜𝚝𝚊:* ${theMusicD.artist.name}
┃⫸ *𝙽𝚘𝚖𝚎 𝚍𝚘 𝚊́𝚕𝚋𝚞𝚖:* ${theMusicD.album.title}
┃⫸ *𝙻𝚒𝚗𝚔 -  𝚊́𝚕𝚋𝚞𝚖:* ${theMusicD.album.link}
╰════ ◍
┃⫸ *𝙴𝚜𝚝𝚊́ 𝚖𝚞́𝚜𝚒𝚌𝚊 𝚎́ 𝚎𝚡𝚙𝚕𝚒́𝚌𝚒𝚝𝚊?* ${theMusicD.explicit_lyrics ? '𝗦𝗜𝗠' : '𝗡𝗔̃𝗢'}
┃⫸ *𝙻𝚒𝚗𝚔 - 𝙿𝚊́𝚐𝚒𝚗𝚊:* ${theMusicD.artist.link}
╰════ ◍
...
return `- *Jogo da forca* - ${DM_FR.palavra_ofc.length} Letras\n\n*Tema:* ${DM_FR.tema}\n\n*Dica:* ${DM_FR.dica}\n
╭━━━━━━╮ 
┃/
┃
┃
